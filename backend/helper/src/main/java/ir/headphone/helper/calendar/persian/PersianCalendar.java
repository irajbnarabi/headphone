 ...
 */
package ir.headphone.helper.calendar.persian;
...
public class PersianCalendar extends GregorianCalendar {
    ...
    public PersianCalendar(TimeZone timeZone, long timeMillis) {
    ...
    private long convertToMilis(long julianDate) {
        return PersianCalendarConstants.MILLIS_JULIAN_EPOCH + julianDate * PersianCalendarConstants.MILLIS_OF_A_DAY
                + PersianCalendarUtils.ceil(getTimeInMillis() + getTimeZone().getRawOffset() - PersianCalendarConstants.MILLIS_JULIAN_EPOCH, PersianCalendarConstants.MILLIS_OF_A_DAY);
    }
    ...
    protected void calculatePersianDate() {
        long julianDate = ((long) Math.floor((getTimeInMillis() + getTimeZone().getRawOffset() - PersianCalendarConstants.MILLIS_JULIAN_EPOCH)) /
    ...
    public void setPersianDate(int persianYear, int persianMonth, int persianDay) {
        ...
        setTimeInMillis(-getTimeZone().getRawOffset() + convertToMilis(PersianCalendarUtils.persianToJulian(this.persianYear > 0 ? this.persianYear
